      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="space-y-1"><Label>Kg / Jerigen</Label><Input type="number" step="0.01" value={form.kg_per_jerigen} onChange={(e) => setForm({ ...form, kg_per_jerigen: +e.target.value })} required /></div>
